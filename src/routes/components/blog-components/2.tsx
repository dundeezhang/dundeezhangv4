...
import Assassin from "./blog/ac-gif.gif";
import Macbook from "./blog/new-laptop.jpeg";
import Math from "./blog/me-in-functions.jpeg";
import Lakehead from "./blog/lakehead-university-campus.jpg";
import Hoodie from "./blog/shad-hoodie-tb.jpeg";
...
export default function ArtTwo() {
    return (
        <div>
            ...
            <div>
            <p>
                July 5, 2024 - High School: A Retrospective
            </p>
            <p>
            ...
            <img className="vert-img" src={Math} alt="Me in Math Class"></img>
            ...
            <img src={Lakehead} alt="Lakehead University Campus UC Building"></img>
            ...
            <img src={Hoodie} alt="Me wearing shad hoodie in a view of Thunder Bay"></img>
